...
<table>
    <tr>
        <td>Activity</td>
        <td>Lawful basis</td>
        <td>GDPR reference</td>
    </tr>
    <tr>
        <td>Collection, use and disclosure of Users&#39; information as described by this privacy policy</td>
        <td>Necessary in order to provide the Service in accordance with the Service [terms](https://pages.treescribe.com/terms-of-service)</td>
        <td>Art 6(1)(b)</td>
    </tr>
    <tr>
        <td>Mailing list</td>
    ...
    <tr>
        <td>International disclosures / processing</td>
        <td>User consent</td>
        <td>Art 6(1)(a)</td>
    </tr>
    <tr>
        <td>Handling Personal Information of non-users whose details are included in agreements created by Users</td>
        <td>Necessary in order to protect Users&#39; vital interests in having effective contracts</td>
        <td>Art 6(1)(d)</td>
    </tr>
</table>
